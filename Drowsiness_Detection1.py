...
def Drowsiness():
    ...
    model = load_model('C:/Users/Admin/Downloads/100% code/100% code/models/cnnCat2.h5')
    path = os.getcwd()
...
button1 = tk.Button(root,text="Drowsiness", command= Drowsiness,width=25,height=2,bd=0,background="pink",foreground="white",font=("Times new roman",17,"bold"))
button1.place(x=100 , y=100)

button2 =tk.Button(root,text="Exit", command= Exit,width=25,height=2,bd=0,background="#454b1b",foreground="white",font=("Times new roman",17,"bold"))
